...
from src.D_star_lite.utils import heuristic_4N, heuristic_8N


LIST_PATH_TO_FILE_MAP = ["../data/movingai_data/maze-map/maze512-1-0.map",
                         "../data/our_data/random_obstacles.map/random_obstacles_2.map",
...
LIST_PATH_TO_FILE_SCENES = ["../data/movingai_data/maze-scen/maze512-1-0.map.scen",
                            "../data/our_data/random_obstacles.map-scen/random_obstacles_2.scen",
...
if "__main__" == __name__:
    ...
    #print(f"list_all_tests={list_all_tests}")
    ...
    search_func = run_d_star_lite.create_search_func(gui=True,
                                                     ...
                                                     #path_saved_photo="../D_star_lite/images/images_for_gif_1",
                                                     #name_saved_photo="D_star_lite_simple_deadlock"
                                                     )
